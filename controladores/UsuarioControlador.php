        ...
        */
        ...
        public function Registrar () {
            if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST["usuario"]) && isset($_POST["password"])):
                ...
                $registerUserRes = $this->soapClient->__soapCall('SelectUserByUsername', array('username' => $username, 'password' => $password, 'key'=> $key));

                if ($registerUserRes == 3) {        //Ya existe ese nombre de usuario
                    $this->result = 3;
                    return;
